...
var crushOutput = "Suỵt! Bé mồm thôi nhé <3 Là chị Nguyễn Khánh Linh đấy <3";
var testCases = [
    ["a", spamOutput],
    ["1", spamOutput],
    ["2", spamOutput],
  ...
  ["crush cua Hoang Minh la ai", crushOutput],
  ["Crush cua admin la ai", crushOutput],
  ["crush của Hoàng Minh là ai", crushOutput],
  ["crush của admin là ai", crushOutput],
    ["-help", helpOutput],
    ["giúp đỡ", helpOutput],
    ["help", helpOutput],
